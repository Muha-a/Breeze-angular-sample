  ...
  app.provider("ngQuickDateDefaults", function() {
    return {
      options: {
        ...
        timeFormat: 'HH:mm',
        labelFormat: null,
        placeholder: 'Выберите чтобы установить дату',
        hoverText: null,
        buttonIconHtml: null,
        closeButtonHtml: '&times;',
        nextLinkHtml: 'След. &rarr;',
        prevLinkHtml: '&larr; Пред.',
