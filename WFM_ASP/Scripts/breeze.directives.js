...
(function () {
    ...
    *     <input data-ng-model='$scope.product.unitPrice' data-z-float />
    */
    function zFloat() {
        return {
            restrict: 'A',
    ...
    *     <input data-ng-model='$scope.session.firstName' data-z-validate />
    *     <input data-ng-model='$scope.session.track' data-z-validate='trackId' />
    *
    ...
    function zValidateInfo() {
        ...
        */
        ...
        function setEntityAndPropertyPaths(info, modelPath, validationPath) {
            ...
            //   '$scope.order.delivery'       // entity path and property
            //   '$scope.order["delivery"]'    // entity path and indexed property
            if (modelPath) {
                parsePath(modelPath);
            }
            ...
            // examples:
            //   '$scope.order,address.street' // entity w/ complex prop 
            //   '$scope.order,address[street]' // entity w/ complex indexed prop 
            if (validationPath) {
                // Look for ',' syntax
